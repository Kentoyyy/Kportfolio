...
public class EducationFragment extends Fragment {
    ...
    public void onCreateDialog(Bundle savedInstanceState) {
        ...
        Button btnresume = (Button)getView().findViewById(R.id.btnMore);
        btnresume.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogResume dialogResume = new DialogResume();
                dialogResume.getChildFragmentManager().beginTransaction().show(getParentFragment());
            }
        });
